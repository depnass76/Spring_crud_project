...
public interface IEmployeeRepository extends PagingAndSortingRepository<Employee, Long> {
	...
	@Query(nativeQuery = true, value = "SELECT FIRST_NAME as FirstName, LAST_NAME as LastName , COUNT(*) as NumberOfProject FROM EMPLOYEE E LEFT JOIN PROJECT_EMPLOYEE PE ON PE.EMPLOYEE_ID = E.EMPLOYEE_ID GROUP BY E.FIRST_NAME,E.LAST_NAME ORDER BY 3 DESC")
